        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-20">
                    ...
                    <a  href="{{ route('admin-ship-create') }}" class="fa-pull-right btn btn-primary waves-effect waves-light text-white text-uppercase" >ADD NEW shipping</a>
    ...
    var deletefunction = function(id){
               ...
               const swalWithBootstrapButtons = Swal.mixin({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                                type: "post",
                                url: "{{url('/admin/shippings/delete')}}",
                                data: {
                                    "_token": "{{ csrf_token() }}",
                                    "id": id
                                    },
