            ...
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    @include('errors.validation')
                     ...
                     <div class="card">
                        {!! Form::model($shipping, ['method' => 'PATCH','route' => ['admin-ship-update', $shipping['id']],'files'=>true]) !!}
                        @csrf
                           ...
                           <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group ">
                                ...
                                <select id="shipping_method" name="shipping_method" class="form-control" required >
                                    ...
                                    @if ($shipping->shipping_method != null)
                                <option  value="{{ $shipping->shipping_method }}" {{$shipping->shipping_method != null ? "selected":""}} >{{ ucfirst($shipping->shipping_method)}}</option>
                                @endif
                            ...
                            <div class="col-xs-8 col-sm-8 col-md-8 text-center">
                                <button type="submit" class="btn btn-primary">{{ __('Update Shipping') }}</button>
                            </div>
                        </div>
                        {!! Form::close() !!}
              </div>
