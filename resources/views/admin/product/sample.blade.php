                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="#">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" id="time-picker" class="form-control floating-label" placeholder="Time">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="#">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="filestyle" data-buttonname="btn-secondary" multiple="multiple">
                                                </div>
