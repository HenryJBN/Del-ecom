        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-20">
                    ...
                    <a  href="{{ route('admin-bill-create') }}" class="fa-pull-right btn btn-primary waves-effect waves-light text-white text-uppercase" >ADD NEW Billing</a>
