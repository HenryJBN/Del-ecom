                ...
                <div class="card-body">
                    ...
                    @include('errors.validation')
                      ...
                      <div class="card">
                        ...
                        {{-- {!! Form::model($category, array('route' => array('admin-cat-update', $category['id'],'files'=>true))) !!} --}}
                                  ...
                                  <div class="row h-100 justify-content-center align-items-center">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-8">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            ...
                                            <div class="image-area mt-4"><img id="imageResult" name="imageResult" src="{{$category->getFirstMediaUrl('category')}}" style="width:20%; margin-top:10px;" alt="" height="20" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
                                    ...
                                    <a href="{{route('admin-cat-index')}}" class="btn btn-secondary">{{ __('Cancel') }}</a>
                                    </div>
                                </div>
                                {!! Form::close() !!}
                      </div>
